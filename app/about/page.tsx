...
export const metadata: Metadata = {
  title: "About Us | Bourne's Ropeworks",
  description: "Learn about Bourne's Ropeworks history as a rope and wire rigging solution provider for marine, industrial, and architectural applications in Manitowoc and Sheboygan, WI.",
};
    ...
    return (
        <>
            <div className="intro-text">
                <h1 className={`${anton.className} text-center text-3xl mb-4 tracking-wide md:text-4xl`}>About Bourne's Ropeworks:<br />
                Wisconsin Rope &amp; Wire Rigging Service</h1>
                <p className="text-center">Bourne’s Ropeworks over 40 years of experience in the splicing and rigging business. We are committed to producing high-quality splicing and rigging. Our passion is splicing rope…any splice or knot you need, we’ll be happy to create!</p>
            </div>
            <Container>
